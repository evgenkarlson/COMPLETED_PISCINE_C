...
/* функция проверки наличия символа в массиве до определенного места(пока счетчик не указывает
 * на конец массива ИИ пока счетчик не равен индексу(или индекс не равен -1)) */
...
int     ft_verif_char(char *str, char c, int index)	/* Принимаем адресс массива, символ, и порядковый номер символа(его индекс) */
{
    ...
    while (str[i] && (i < index || index == -1))	/* запускаем цикл, который ищет символ в массиве до тех пор пока счетчик не указывает
													 * на конец массива ИИ пока счетчик не равен индексу(или индекс не равен -1) */
    {
