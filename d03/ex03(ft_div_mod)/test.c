...
/*   Updated: 2020/09/28 18:40:09 by evgenkarlson     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	ft_div_mod(i, t, &D, &M);		/* Вызываем функцию и отправляем туда делимое, делитель, и адреса переменных в которые хотим записать результат деления и остаток от деления */
