...
/*   Updated: 2020/09/30 10:42:28 by evgenkarlson     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**  неверных аргументов:
**  	◦ Если база системы счисления пуста или имеет размер 1;
**  	◦ Если база системы счисления содержит один и тот же символ дважды;
**  	◦ Если база системы счисления содержит символы '+' или '-';
**  	◦ и т. д.
**  
** 
** ***********************************P.S.***********************************
