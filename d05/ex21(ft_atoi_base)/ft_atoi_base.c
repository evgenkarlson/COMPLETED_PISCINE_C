...
/*   Updated: 2020/09/30 10:30:44 by evgenkarlson     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**  
**  
**  •  Создайте функцию, которая возвращает число. Это число функция добудет
**  и сможет вернуть, после конвертирования в десятичную систему счисления
**  строки содержащей цепочку сиволов.
**  •  Строка символов  представляет собой число в определенной системе
**  счисления(заданной во втором параметре).
**  •  Функция должна обрабатывать отрицательные числа.
**  •  Функция должна обрабатывать такие знаки, как и в документации 'man atoi'.
...
**  	◦ Если строка 'str' содержит символы, которые не являются частью
**  	конвертируеммой базовой системы счисления или не являются символами
**      '+' или '-';
