...
/*   Updated: 2020/09/28 19:12:03 by evgenkarlson     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_strlcat(char *dest, char *src, unsigned int size)	/* принимаем адреса строк dest и src для Конкатенации и размер массива dest*/
{
