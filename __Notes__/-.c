...
int (*pa)[]; 		/* a pointer to an array of ints*/ /* указатель на массив целых */
...
int * p;		/* указатель на int (от ptr до int) */
int a [];		/* массив целых чисел */
int f ();		/* функция, возвращающая int */
int ** pp;		/* указатель на указатель на int (ptr на ptr на int) */
int (* pa) [];		/* указатель на массив целых */
int (* pf) ();		/* указатель на функцию, возвращающую int */
int * ap [];		/* массив указателей на int (массив от ptrs до ints) */
