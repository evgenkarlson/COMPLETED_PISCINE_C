...
# • Создайте ИСХОДНЫЕ ФАЙЛЫ с функциями и СКРИПТ, который создает библиотеку libft.a из созданых нами исходный файлов с помощью программы "ar".
# • Сама же библиотека libft.a будет состоять из обьектных файлов наших исходников.
...
#
#  P.S. Не стесняйтесь добавлять другие полезные функции ...
