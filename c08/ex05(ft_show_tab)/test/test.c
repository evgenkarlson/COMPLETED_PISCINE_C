...
/*   Updated: 2020/10/19 13:35:09 by evgenkarlson     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int    				 main(void)	/* Основаная функция */
{
	...
	struct s_stock_str *a;		/* Создаем указатель на экземпляр структуры типа t_stock_str"(struct s_stock_par) */
	...
	ft_show_tab(a);				/* Печатаем полученый в указатель адресс массива экземпляров типа t_stock_str"(struct s_stock_par) содержащий аргументы программы 
