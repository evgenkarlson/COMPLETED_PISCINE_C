...
struct s_stock_par	*ft_param_to_tab(int ac, char **av)	/* Функция получает количество строк в "ac" и сам массив со строками в "av" и разбирает его на состовляющие, .
														 * выделяет память для структуры "struct s_stock_par"  в которую все это сохранится и возвращает адрес экземпляра
														 * структуры "struct s_stock_par" */
{
