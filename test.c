...
void	*ft_atoi_base(int nbr, char *base)
{
											...
											/* Если проверка прошла успешно и мы получили число отражающее систему счисления то запускаем код внутри  */
	{
		...
		while (i > 0)						/* Запускаем цикл который восстановить порядок найденых нами значений символов и запишет их в final */
		{
			--i;							/* Уменьшаем счетчик чтобы двигаться по отдающему символу массиву вниз */
