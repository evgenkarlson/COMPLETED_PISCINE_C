...
int		ft_atoi(char *str)		/* Функция конвертирует строку с символами чисел в целое число */
{
	int		is_negative;
	int		value;
...
void	ft_advanced_sort_wordtab(char **tab, int(*cmp)(char *, char *))	/* Функция сортирует массив со строками по возростанию.
...
int		main(void)
{
	...
	ft_advanced_sort_wordtab(point, &ft_strcmp);/* Отправим добытый из прошлой функции адресс массива строк и адресс фунции 'ft_strcmp'
