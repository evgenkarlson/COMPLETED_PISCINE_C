...
void	ft_sort_wordtab(char **tab)	/* Функция сортирует массив со строками по возростанию */
{
...
int		main(void)
{
	...
	ft_sort_wordtab(point);				/* Отправим добытый из прошлой функции адресс массива строк в функцию,
