...
>  _Для корректного отображения содержимого всех файлов - склонируйте репозиторий себе на компьютер и открывайте файлы через любой удобный вам редактор текста._
