...
Что бы скомпилировать файл "test.c" содержащий написаный напи код программы - откройте окно терминала и с помощью команды 'cd' перейдите в папку где находится этот файл c кодом(допустим у меня он лежит в папке Документы): 
