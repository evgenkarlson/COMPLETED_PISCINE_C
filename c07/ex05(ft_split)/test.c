...
/*   Updated: 2020/10/15 21:59:06 by evgenkarlson     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
										...
										** этот адресс массива указателей на указатели */
{
										...
										** результат в переменную 'words'. Если слова есть то запускаем код внутри */
	{
										...
										** сохранятся в массиве указателей */
		{
			...
			i = j;						/* Перезаписываем переменную 'i' сохраняя в ней число указывающее на ячейку с символом, 
...
int     main(void)						/* Основаная функция */
{
	...
	if ((arr_str = ft_split("_hello$my$##cool=friend!+", "_=$+#@")) == ((void *)0)) /* Запускам функцию нахождения в строке 
