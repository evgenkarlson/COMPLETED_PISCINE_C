...
*	
*	
*	• Эта функция возвращает массив, в котором каждое поле содержит адрес 
*	строки символов, представленный словом. Последний элемент этого массива 
*	должен быть равен 0, чтобы подчеркнуть конец массива.
*	
*	
