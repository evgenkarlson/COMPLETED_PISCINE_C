 ...
 *
 * 
 *	• Создайте функцию «ft_list_sort», которая сортирует содержимое списка по 
 *	возрастанию, сравнивая две ссылки, благодаря функции, которая может сравни-
 *	вать данные, содержащиеся в этих двух ссылках.
 *
 * 
