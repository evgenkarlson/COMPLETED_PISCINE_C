...
int			main(void)
{
	...
	temp = ft_list_foreach_if(list, &ft_putstr, list->next->next->data, &ft_strcmp);/* Ищем в текущей цепи связанных между собой экземпляров структур нужный 
										 * нам экземпляр с такой же строкой внутри */
	ft_putstr((char *)temp->data);
