...
void	ft_list_reverse(t_list **begin_list)
{
	...
	while (*begin_list)
	{
		...
		(*begin_list)->next = new_start;/* Перезаписываем указатель хранящий адрес следующего экземпляра используя сохраненный адрес первого в цепи
										 * экземпляра структуры с прошлой итерации цикла */

		new_start = *begin_list;		/* Сохраняем адрес первого в цепи экземпляра структуры */
		*begin_list = tmp;				/* Презаписываем указатель хранящий адрес первого в цепи экземпляра структуры используя сохраненный
										 * адресс следующего экземпляра структуры */
	}
